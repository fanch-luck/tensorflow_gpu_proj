...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 15 13:57:36 2021
...
# 模型保存的路径和文件名
MODEL_SAVE_PATH = "cifar_ok_result"
MODEL_NAME = "test_cifar"
  
# 加载需要预测的图片
image_data = tf.gfile.FastGFile(r"R:\workspaces\tensorflow_proj\cifar_ok\test_batch_parsed\abandoned_ship_s_000213.png", 'rb').read()
...
# saver = tf.train.import_meta_graph(r"R:\workspaces\tensorflow_proj\cifar_ok_result\test_cifar.meta")
